...
namespace BMA.Models
{
    ...
    public partial class BMAEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<System.Guid>> SqlQueryNotificationStoredProcedure_046493a5_ec93_44eb_bb54_9f817ef8de0c()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<System.Guid>>("SqlQueryNotificationStoredProcedure_046493a5_ec93_44eb_bb54_9f817ef8de0c");
        }
    }
}
